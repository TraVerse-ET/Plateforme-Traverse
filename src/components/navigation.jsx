          ...
          <div className="navbar-header">
            ...
            <a className="navbar-brand page-scroll" href="#page-top">
              ...
              <img
                ...
                src="/img/Logo-e.png"
                alt="ExploTech Logo"
                style={{ width: "100px", height: "100px", marginTop: "-39px" }}
              ></img>
            </a>{" "}
          </div>
                ...
                <a href="#" className="page-scroll">
                  {!token ? (
                    <button
                      type="button"
                      onClick={handleLogin}
                      className="page-scroll bg-transparent hover:bg-blue-500 text-blue-700  hover:text-white border-none hover:border-transparent rounded"
                    >
                      SIGN IN
                    </button>
                  ) : (
