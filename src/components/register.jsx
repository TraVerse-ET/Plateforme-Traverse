...
return(
  ...
  <div className="container max-w-screen-lg mx-auto">
    <div>
      ...
      <p className="text-gray-500 mb-6">Register here to help us</p>

      <form onSubmit={handleSubmit} className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div className="text-gray-600">
            <p className="font-medium text-lg">Personnal Details</p>
          ...
          <div className="lg:col-span-2">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div className="md:col-span-5">
                ...
                <input type="password" name="password" id="password" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="****" />
              </div>
